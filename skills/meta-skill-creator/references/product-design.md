...
meta-skill-creator/
  SKILL.md
  references/
    intent-domain-research.md
    product-design.md
    experience-surface-model.md
    skill-contract.md
    evidence.md
    source-abstraction-boundary.md
    release-gate.md
  assets/
    domain-research-brief-template.md
    skill-contract-template.md
    package-plan-template.md
    eval-plan-template.md
    product-design-board-template.md
  scripts/
    check_meta_skill_package.py
  evals/
    trigger-eval.json
    output-eval.md
    baseline-compare.md
    regression-ab.md
    satisfaction-rubric.md
  examples/
    example-input.md
    example-output.md
  verification-summary.md
